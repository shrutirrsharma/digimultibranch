                        ...
                        if (hpf.ContentLength > 0)
                        {
                                ...
                                Path.GetFileName(hpf.FileName)))
                            {
                                ...
                                else
                                {
                                    ...
                                    Byte[] bytesfile = File.ReadAllBytes("C:\\KhalidSir\\DigitalSignature\\pdfDocument\\" + sFileName);
